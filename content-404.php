<style>
	.cavmain{background:#000; overflow:hidden; position:relative; height:600px;;}
#container{height:600!important;max-width:2000px;background: rgb(0, 0, 0);}
</style>
<section class="container" style="max-width: 2000px;">
	<div class="faded404">
		<div class="f404">
			...
			<h2>沒有找到你要的内容！</h2> 
			<p>
			<a class="btn btn-primary btn404" id="back" href="<?php echo get_bloginfo('url') ?>">返回 <?php echo get_bloginfo('name') ?> 首页</a>
		</p>
